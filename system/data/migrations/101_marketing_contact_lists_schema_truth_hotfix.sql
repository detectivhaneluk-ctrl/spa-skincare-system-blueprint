-- Hotfix: ensure marketing contact list tables exist even in environments where
-- migrations were stamped from canonical schema without these tables.
...
CREATE TABLE IF NOT EXISTS marketing_contact_list_members (
    id BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
