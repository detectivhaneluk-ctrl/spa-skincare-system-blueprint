...
<?php endif; ?>
<form method="post" action="/inventory/suppliers" class="entity-form">
    ...
    <div class="form-actions"><button type="submit">Create</button> <a href="/inventory/suppliers">Cancel</a></div>
</form>
