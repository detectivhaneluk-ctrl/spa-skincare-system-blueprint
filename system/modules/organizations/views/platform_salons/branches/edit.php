...
/** @var array{id:int,name:string,code:string} $branch */
...
<div class="workspace-shell platform-control-plane">
    <div class="founder-mutation">
        ...
        <div class="founder-mutation__card">
            ...
            <p class="founder-mutation__hint"><?= htmlspecialchars($salonName) ?> · #<?= $bid ?></p>
            ...
            <?php endforeach; ?>
            <form method="post" action="/platform-admin/salons/<?= (int) $organizationId ?>/branches/<?= $bid ?>" class="founder-mutation__form">
