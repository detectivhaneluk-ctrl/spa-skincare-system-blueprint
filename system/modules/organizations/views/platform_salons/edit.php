...
<div class="workspace-shell platform-control-plane">
    <div class="founder-mutation">
        ...
        <div class="founder-mutation__card">
            ...
            <?php endforeach; ?>
            <form method="post" action="/platform-admin/salons/<?= $id ?>" class="founder-mutation__form founder-mutation__form--identity">
                ...
                <p class="founder-mutation__field-muted" id="salon-code-hint">Optional. Leave empty to clear.</p>
                <input type="text" id="salon-code" name="code" maxlength="50" value="<?= htmlspecialchars((string) ($org['code'] ?? '')) ?>" aria-describedby="salon-code-hint">
