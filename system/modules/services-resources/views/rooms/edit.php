...
<?php endif; ?>
<form method="post" action="/services-resources/rooms/<?= (int) $room['id'] ?>" class="entity-form">
    ...
    <div class="form-row">
        <label><input type="checkbox" name="is_active" value="1" <?= !empty($room['is_active']) ? 'checked' : '' ?>> Active</label>
    </div>
    <div class="form-row">
    ...
    <div class="form-actions">
        ...
        <a href="/services-resources/rooms/<?= (int) $room['id'] ?>">Cancel</a>
    </div>
</form>
