...
<?php endif; ?>
<form method="post" action="/services-resources/equipment" class="entity-form">
    ...
    <div class="form-row">
        <label><input type="checkbox" name="is_active" value="1" <?= !isset($item['is_active']) || !empty($item['is_active']) ? 'checked' : '' ?>> Active</label>
    </div>
    <div class="form-row">
    ...
    <div class="form-actions">
        ...
        <a href="/services-resources/equipment">Cancel</a>
    </div>
</form>
