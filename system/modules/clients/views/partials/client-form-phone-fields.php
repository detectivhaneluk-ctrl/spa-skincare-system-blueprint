...
?>
<h2 class="client-ref-block-title">Contact &amp; phones</h2>
<div class="form-row">
    <label for="phone_home">Home phone</label>
    <input type="text" id="phone_home" name="phone_home" maxlength="50" value="<?= $v('phone_home') ?>">
...
<div class="form-row">
    ...
    <input type="text" id="phone_mobile" name="phone_mobile" maxlength="50" value="<?= htmlspecialchars($phoneMobileVal, ENT_QUOTES, 'UTF-8') ?>">
...
<div class="form-row">
    ...
    <input type="text" id="phone_work" name="phone_work" maxlength="50" value="<?= $v('phone_work') ?>">
