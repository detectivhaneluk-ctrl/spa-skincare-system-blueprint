...
$container->singleton(\Modules\Memberships\Services\MembershipSaleService::class, fn ($c) => new \Modules\Memberships\Services\MembershipSaleService($c->get(\Core\App\Database::class), $c->get(\Modules\Memberships\Repositories\MembershipSaleRepository::class), $c->get(\Modules\Clients\Repositories\ClientRepository::class), $c->get(\Modules\Memberships\Repositories\MembershipDefinitionRepository::class), $c->get(\Modules\Sales\Services\InvoiceService::class), $c->get(\Modules\Sales\Repositories\InvoiceRepository::class), $c->get(\Modules\Memberships\Services\MembershipService::class), $c->get(\Core\Audit\AuditService::class), $c->get(\Core\Branch\BranchContext::class), $c->get(\Core\App\SettingsService::class), fn () => $c->get(\Core\Contracts\PublicCommerceFulfillmentReconciler::class), $c->get(\Modules\PublicCommerce\Services\PublicCommerceFulfillmentReconcileRecoveryService::class)));
...
$container->singleton(\Modules\Sales\Services\PaymentMethodService::class, fn ($c) => new \Modules\Sales\Services\PaymentMethodService($c->get(\Modules\Sales\Repositories\PaymentMethodRepository::class)));
$container->singleton(\Modules\Sales\Services\VatRateService::class, fn ($c) => new \Modules\Sales\Services\VatRateService($c->get(\Modules\Sales\Repositories\VatRateRepository::class)));
$container->singleton(\Modules\Sales\Services\RegisterSessionService::class, fn ($c) => new \Modules\Sales\Services\RegisterSessionService($c->get(\Modules\Sales\Repositories\RegisterSessionRepository::class), $c->get(\Modules\Sales\Repositories\CashMovementRepository::class), $c->get(\Modules\Sales\Repositories\PaymentRepository::class), $c->get(\Core\App\Database::class), $c->get(\Core\Audit\AuditService::class), $c->get(\Core\Branch\BranchContext::class)));
$container->singleton(\Modules\Sales\Services\ReceiptInvoicePresentationService::class, fn ($c) => new \Modules\Sales\Services\ReceiptInvoicePresentationService($c->get(\Core\App\SettingsService::class), $c->get(\Core\App\Database::class)));
$container->singleton(\Modules\Sales\Services\PaymentService::class, fn ($c) => new \Modules\Sales\Services\PaymentService($c->get(\Modules\Sales\Repositories\PaymentRepository::class), $c->get(\Modules\Sales\Repositories\InvoiceRepository::class), $c->get(\Modules\Sales\Repositories\RegisterSessionRepository::class), $c->get(\Modules\Sales\Services\InvoiceService::class), $c->get(\Core\Contracts\InvoiceGiftCardRedemptionProvider::class), $c->get(\Modules\Sales\Services\PaymentMethodService::class), $c->get(\Core\App\SettingsService::class), $c->get(\Core\Audit\AuditService::class), $c->get(\Core\App\Database::class), $c->get(\Core\Branch\BranchContext::class), $c->get(\Core\Organization\OrganizationScopedBranchAssert::class), $c->get(\Modules\Notifications\Services\NotificationService::class), $c->get(\Core\Contracts\MembershipInvoiceSettlementProvider::class), $c->get(\Core\Contracts\ReceiptPrintDispatchProvider::class), $c->get(\Modules\PublicCommerce\Services\PublicCommerceFulfillmentReconcileRecoveryService::class), fn () => $c->get(\Core\Contracts\PublicCommerceFulfillmentReconciler::class)));
