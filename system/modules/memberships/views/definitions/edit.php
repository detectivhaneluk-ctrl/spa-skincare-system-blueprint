<?php
$title = 'Edit Membership Definition';
ob_start();
?>
<h1>Edit Membership Definition</h1>
...
<form method="post" action="/memberships/<?= (int) $definition['id'] ?>" class="entity-form">
    ...
    <div class="form-row">
        ...
        <input type="number" id="price" name="price" min="0" step="0.01" value="<?= ($definition['price'] ?? null) !== null && $definition['price'] !== '' ? htmlspecialchars((string) $definition['price']) : '' ?>">
    </div>
    <div class="form-row">
        <label>
    ...
    <div class="form-actions"><button type="submit">Save</button> <a href="/memberships">Cancel</a></div>
</form>
