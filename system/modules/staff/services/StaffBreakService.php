...
final class StaffBreakService
{
    public function __construct(
        private StaffBreakRepository $repo,
    ...
    public function update(int $id, array $data): void
    {
        ...
        if (!$row) {
            throw new \RuntimeException('Break entry not found.');
        }
    ...
    /**
     * @return array{day_of_week: int, start_time: string, end_time: string, title: string|null}
     */
