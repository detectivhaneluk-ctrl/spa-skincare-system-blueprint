<?php
$title = 'New Employee : Step 4 of 4';
ob_start();
?>
<div class="wizard-layout">
    ...
    <div class="wizard-body">
        <header class="wizard-body__header">
            ...
            <p class="wizard-body__subtitle">Step 4 of 4</p>
        ...
        <div class="wizard-placeholder">
            ...
            <h2 class="wizard-placeholder__heading">Step 4 is not yet implemented</h2>
            ...
            <p class="wizard-placeholder__body">
                Step 4 will be available in a future release. The employee record is already accessible
                and can be viewed and edited through the standard staff management interface.
            </p>
            <div class="wizard-placeholder__actions">
                <a href="/staff/<?= (int) ($staff['id'] ?? 0) ?>/onboarding/step3" class="btn btn--secondary">Back to Step 3</a>
                <a href="/staff/<?= (int) ($staff['id'] ?? 0) ?>" class="btn btn--primary">View Employee Record</a>
                <a href="/staff" class="btn btn--ghost">Back to Staff List</a>
            </div>
        </div>
