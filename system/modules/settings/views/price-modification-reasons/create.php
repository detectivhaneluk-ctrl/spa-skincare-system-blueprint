<?php
$title = 'Add Price Modification Reason';
$reason = $reason ?? ['code' => '', 'name' => '', 'description' => '', 'is_active' => true, 'sort_order' => 0];
$errors = $errors ?? [];
ob_start();
...
<section class="settings-establishment">
    <header class="settings-establishment__hero">
        <h2 class="settings-establishment__title">Add price modification reason</h2>
        <p class="settings-establishment__lead">
            Adds a reusable internal reason for manual price changes and overrides.
        </p>
    ...
    <div class="settings-establishment-card settings-establishment-card--full">
        ...
        <?php endif; ?>
        <form method="post" action="/settings/price-modification-reasons" class="settings-form entity-form">
            ...
            <div class="settings-grid">
                <div class="setting-row">
                    ...
                    <p class="setting-help">Machine-friendly and stable (example: <code>manager_override</code>).</p>
                </div>
                <div class="setting-row">
