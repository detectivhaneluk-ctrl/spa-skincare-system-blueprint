...
- FND-TNT-21 (2026-03-29 wave): `AppointmentRepository::hasStaffConflict` uses `branchColumnOwnedByResolvedOrganizationExistsClause('a')`; proof `verify_tenant_closure_wave_fnd_tnt_21_readonly_01.php` in Tier A — **does not** close buffered staff overlap / universal repo coverage.
