...
$router->get('/clients/duplicates', [\Modules\Clients\Controllers\ClientController::class, 'duplicates'], [AuthMiddleware::class, \Core\Middleware\TenantProtectedRouteMiddleware::class, \Core\Middleware\PermissionMiddleware::for('clients.view')]);
...
$router->get('/clients/merge', [\Modules\Clients\Controllers\ClientController::class, 'mergePreview'], [AuthMiddleware::class, \Core\Middleware\TenantProtectedRouteMiddleware::class, \Core\Middleware\PermissionMiddleware::for('clients.edit')]);
