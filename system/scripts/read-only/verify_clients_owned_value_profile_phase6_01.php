 ...
 * Membership summary explicit gap until a profile provider exists.
 *
...
cv6('V6: show states membership profile gap honestly', $show, 'not summarized on this profile yet');
