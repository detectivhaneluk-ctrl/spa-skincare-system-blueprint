...
chk('C7b: service show Applies to room label absent', $svcShow, 'Applies to room', false);
chk('C7c: service show Applies to space label present', $svcShow, 'Applies to space');
chk('C7d: service show no Room # fallback copy', $svcShow, 'Room #', false);
