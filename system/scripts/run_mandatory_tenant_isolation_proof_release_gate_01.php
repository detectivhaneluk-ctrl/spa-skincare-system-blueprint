 ...
 *   1. verify_sales_invoice_payment_tenant_mutation_guard_readonly_01.php
 *   2. verify_cross_module_invoice_payment_read_guard_readonly_01.php
 *   3. verify_sales_invoice_payment_tenant_read_guard_readonly_01.php
 *   4. verify_public_commerce_json_controller_staff_boundary_wave_01.php
 *   5. verify_payroll_invoice_payment_tenant_guard_readonly_01.php
 *   6. verify_tenant_repository_footguns.php
 *   7. verify_client_merge_job_repository_org_scope_plt_tnt_01.php (PLT-TNT-01 merge-job org predicates)
 *   8. verify_tenant_branch_access_legacy_suspended_org_plt_lc_01.php (PLT-LC-01 legacy pin + branch-context choke)
 *   9. verify_public_commerce_purchase_invoice_correlation_fnd_tnt_05.php (FND-TNT-05 PC purchase ↔ invoice correlation)
 *  10. verify_invoice_client_read_envelope_fnd_tnt_06.php (FND-TNT-06 invoice/cashier client read envelope)
