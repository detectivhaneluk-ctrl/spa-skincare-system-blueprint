...
$allowlist = [
    ...
    'modules/packages/services/PackageService.php|clientPackages|find' => 'Read-back of specific client_package id for controlled service methods.',
    'modules/packages/services/PackageService.php|clients|find' => 'Existence gate only; no cross-tenant list/read payload.',
    'modules/gift-cards/Services/GiftCardService.php|cards|find' => 'Card id lookup for same-branch guarded operations.',
